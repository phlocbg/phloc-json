...
/**
 * An implementation of {@link IJsonParseErrorHandler} that does nothing. So in
 * case a recoverable error occurs it is silently ignored.
 * 
 * @author Philip Helger
 */
public final class DoNothingJsonParseErrorHandler implements IJsonParseErrorHandler
{
  private static final DoNothingJsonParseErrorHandler s_aInstance = new DoNothingJsonParseErrorHandler ();

  private DoNothingJsonParseErrorHandler ()
  {}
   ...
   */
  @Nonnull
  public static DoNothingJsonParseErrorHandler getInstance ()
  {
    return s_aInstance;
  }
