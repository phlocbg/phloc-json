...
public final class JsonCharStream implements CharStream
{
  ...
  public JsonCharStream (@Nonnull final Reader aReader)
  {
    this (aReader, 1, 1, DEFAULT_BUF_SIZE);
  }

  private JsonCharStream (@Nonnull final Reader aReader,
